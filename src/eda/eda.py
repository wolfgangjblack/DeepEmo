...
files_to_keep = get_files_to_keep(data_dir, class_labels)
...
get_metric_subplots(class_labels, lengths, "file lengths at "+ str(quantile)+" quantile", './artifacts/')
get_metric_subplots(class_labels, native_sample_rates, "native sample rates", './artifacts/')
...
##save off two text files, one with files to ignore (for later records) and one with files to use in training/testing
# this is being defined in the EDA and saved for consistancy 